  ...
  <div class="col-md-12 col-lg-4">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="text-primary mb-1" style="font-size: 1.0rem;">{{ $indicadores['produto_mais_vendido']->produto }} (R$ {{ number_format($indicadores['produto_mais_vendido']->vlr_unitario, 2, ',', '.') }})</h4>
        <p class="mb-2 pb-1 mt-3">78% da meta 🚀</p>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                <div class="small mb-1">Categoria <strong>{{ $indicadores['grupo_mais_vendido']->categoria }}</strong></div>
...
<div id="app" data-indicadores='@json($indicadores)'></div>
